...
public class Knockback : MonoBehaviour
{
    ...
    {
        yield return new WaitForSeconds(0.25f); // .5f
...
//        transform.eulerAngles = new Vector3(0, 0, angle);
//        rbody.velocity = -this.gameObject.transform.right * force;
//        StartCoroutine(WaitCo(rbody, enemyS));
//    }

//    public IEnumerator WaitCo(Rigidbody2D rb, Enemy enemy)
//    {
...
//    if (enemyS != null) // enemy
//    {
//        enemyS.normalSprite();
//        if (enemyS.health > 0) // enemy
//        {
//            Debug.Log("Enemy Health: " + enemyS.health);
//            yield return new WaitForSeconds(stunTime);
//            enemyS.paused = false; // enemy
//        }
//        enemyS = null;
//    }
//    obj2 = null;
